export default function CRMSidebar({ sections, activeView, onSelect, onBack }) {
  return (
    <aside className="w-72 bg-white border-r border-gray-100 flex flex-col h-screen sticky top-0 shrink-0 transition-all duration-300 text-left shadow-sm">
      <div className="p-6 border-b border-gray-100 text-left">
        ...
        <div className="flex items-center gap-4 text-left">
          <div className="w-12 h-12 bg-emerald-500 rounded-2xl flex items-center justify-center text-white shadow-xl shadow-emerald-100 text-left shrink-0">
            <span className="text-xl font-black font-heading">C</span>
          </div>
