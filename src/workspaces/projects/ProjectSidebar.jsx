export default function ProjectSidebar({ activeView, onSelect, onBack, sections }) {
      ...
      <div className="p-6 border-b border-gray-100 text-left">
        ...
        <div className="flex items-center gap-4 text-left">
          ...
          <div className="text-left">
              <h2 className="font-black text-[#111827] text-lg tracking-tighter leading-none text-left">Project Hub</h2>
              <p className="text-[10px] text-[#195bac] font-bold uppercase tracking-widest mt-1 text-left">Tactical Sync</p>
          </div>
        </div>
      </div>
