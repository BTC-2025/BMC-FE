export default function HRSidebar({ sections, activeView, onSelect, onBack }) {
  return (
    <aside className="w-64 bg-white border-r border-gray-100 flex flex-col h-screen sticky top-0 shrink-0 transition-all duration-300 text-left shadow-sm">
      <div className="p-6 border-b border-gray-100 text-left">
        ...
        <div className="flex items-center gap-4 text-left">
          <div className="w-12 h-12 bg-[#195bac] rounded-2xl flex items-center justify-center text-white shadow-xl shadow-gray-200 text-left shrink-0">
          ...
          <div className="text-left">
            ...
            <p className="text-[10px] text-[#195bac] font-black font-subheading uppercase tracking-widest mt-1 text-left">
              HRM Sync
            </p>
          </div>
        </div>
              ...
              {section.items.map((item) => (
                ...
                >
                  <div className="flex items-center gap-4 text-left">
                    ...
                    <span
                      className={`text-[13px] ${activeView === item.id ? "font-black font-heading" : "font-black font-subheading"} tracking-tight uppercase`}
                    >
                      {item.label}
                    </span>
                  </div>
