export default function SupplyChainSidebar({ activeView, onSelect, onBack, sections }) {
    ...
    <aside className="w-64 bg-white border-r border-gray-100 flex flex-col h-screen sticky top-0 shrink-0 transition-all duration-300 text-left shadow-sm">
      <div className="p-6 border-b border-gray-100 text-left">
        ...
        <div className="flex items-center gap-4 text-left">
          <div className="w-12 h-12 bg-cyan-600 rounded-2xl flex items-center justify-center text-white shadow-xl shadow-cyan-100 text-left shrink-0">
             <span className="text-xl font-black">S</span>
          </div>
          <div className="text-left">
              <h2 className="font-black text-[#111827] text-lg tracking-tighter leading-none text-left">SCM Hub</h2>
              <p className="text-[10px] text-cyan-600 font-bold uppercase tracking-widest mt-1 text-left">Supply Sync</p>
          </div>
        </div>
      </div>
